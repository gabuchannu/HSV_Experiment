...
def face_landmark_find(img, frame_count):
    ...
    #書き換えポイント
    f = open("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_csv/shimizu/cut_time_data/h60_v64.csv", "a") #追記モードでファイルを開く
    ...
    if len(faces) == 0: #顔検出ができていなかったら
        ...
        for i in range(0, height_img2):
            for j in range(0, weight_img2):
                ...
                if (H_value > 60) or (V_value <= 64): #削りたい場所だったら
...
def smooth_data():
    #書き換えポイント
    df = pd.read_csv("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_csv/shimizu/cut_time_data/h60_v64.csv", encoding="utf-8") #先に作成したデータファイルを開く 
    ...
    #csvファイルとして書き出しをする
    analysis_data.to_csv("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_csv/shimizu/cut_time_data/remake_h60_v64.csv", encoding="utf_8")
...
def make_graph():
    ...
    analysis_data = pd.read_csv("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_csv/shimizu/cut_time_data/remake_h60_v64.csv", encoding="utf-8")
    ...
    fig_nose_h.savefig("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_graph/shimizu/cut_time_data/nose_h60_v64_h.png")
    fig_nose_s.savefig("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_graph/shimizu/cut_time_data/nose_h60_v64_s.png")
    fig_nose_v.savefig("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_graph/shimizu/cut_time_data/nose_h60_v64_v.png")
...
if __name__=="__main__":
    ...
    #書き換えポイント
    f = open("/Users/shimizu_italab/Desktop/Study/HSV_Experiment/result_csv/shimizu/cut_time_data/h60_v64.csv", "a") #新規作成モードでファイルを開く
